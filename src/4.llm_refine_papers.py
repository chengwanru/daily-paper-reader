...
def call_filter(
    ...
    user_prompt = (
        ...
        "The reader studies abroad: keep Chinese prose in tldr_cn / title_zh / overview fields, "
        "but technical terms should appear bilingually like '自注意力（self-attention）'. "
        ...
        "Also generate four Chinese overview fields: motivation_cn, method_cn, result_cn, conclusion_cn. "
        ...
        "Keep Chinese prose, but for technical terms / model names / datasets / metrics write bilingual forms like "
        "'自注意力（self-attention）' or keep the English proper noun with a short Chinese gloss. "
        "Do not put full English sentences in these Chinese fields. "
